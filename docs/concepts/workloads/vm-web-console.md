...
- **v1alpha6**: `VirtualMachineWebConsoleRequest` (current, storage version)

Use v1alpha6 for new deployments as it's the current storage version and provides the most stable API surface.
