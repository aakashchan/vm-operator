...
// -kubebuilder:webhook:path=/default-mutate-vmoperator-vmware-com-v1alpha6-virtualmachineservice,mutating=true,failurePolicy=fail,groups=vmoperator.vmware.com,resources=virtualmachineservices,verbs=create;update,versions=v1alpha6,name=default.mutating.virtualmachineservice.v1alpha6.vmoperator.vmware.com,sideEffects=None,admissionReviewVersions=v1;v1beta1
