...
// +kubebuilder:webhook:path=/default-mutate-vmoperator-vmware-com-v1alpha6-virtualmachinereplicaset,mutating=true,failurePolicy=fail,groups=vmoperator.vmware.com,resources=virtualmachinereplicasets,verbs=create;update,versions=v1alpha6,name=default.mutating.virtualmachinereplicaset.v1alpha6.vmoperator.vmware.com,sideEffects=None,admissionReviewVersions=v1;v1beta1
