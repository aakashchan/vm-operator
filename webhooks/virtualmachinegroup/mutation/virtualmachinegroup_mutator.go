...
// +kubebuilder:webhook:path=/default-mutate-vmoperator-vmware-com-v1alpha6-virtualmachinegroup,mutating=true,failurePolicy=fail,groups=vmoperator.vmware.com,resources=virtualmachinegroups,verbs=create;update,versions=v1alpha6,name=default.mutating.virtualmachinegroup.v1alpha6.vmoperator.vmware.com,sideEffects=None,admissionReviewVersions=v1;v1beta1
