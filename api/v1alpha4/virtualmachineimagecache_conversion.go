...
func (src *VirtualMachineImageCache) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha4_VirtualMachineImageCache_To_v1alpha6_VirtualMachineImageCache(src, dst, nil); err != nil {
		return err
	}
...
func (dst *VirtualMachineImageCache) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha6_VirtualMachineImageCache_To_v1alpha4_VirtualMachineImageCache(src, dst, nil); err != nil {
		return err
	}
...
func (src *VirtualMachineImageCacheList) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha4_VirtualMachineImageCacheList_To_v1alpha6_VirtualMachineImageCacheList(src, dst, nil)
}
...
func (dst *VirtualMachineImageCacheList) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha6_VirtualMachineImageCacheList_To_v1alpha4_VirtualMachineImageCacheList(src, dst, nil)
}
