...
func (src *VirtualMachineReplicaSet) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha4_VirtualMachineReplicaSet_To_v1alpha6_VirtualMachineReplicaSet(src, dst, nil); err != nil {
		return err
	}
...
func (dst *VirtualMachineReplicaSet) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha6_VirtualMachineReplicaSet_To_v1alpha4_VirtualMachineReplicaSet(src, dst, nil); err != nil {
		return err
	}
...
func (src *VirtualMachineReplicaSetList) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha4_VirtualMachineReplicaSetList_To_v1alpha6_VirtualMachineReplicaSetList(src, dst, nil)
}
...
func (dst *VirtualMachineReplicaSetList) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha6_VirtualMachineReplicaSetList_To_v1alpha4_VirtualMachineReplicaSetList(src, dst, nil)
}
