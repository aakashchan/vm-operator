...
// +kubebuilder:deprecatedversion:warning="v1alpha4 VirtualMachineReplicaSet is deprecated; use v1alpha6 VirtualMachineReplicaSet"

// VirtualMachineReplicaSet is the schema for the virtualmachinereplicasets API.
//
// Deprecated: This type is deprecated and will be removed in a future release.
// Please use v1alpha6.VirtualMachineReplicaSet instead.
