...
func Convert_v1alpha1_VirtualMachineSetResourcePolicySpec_To_v1alpha6_VirtualMachineSetResourcePolicySpec(
	...
	return autoConvert_v1alpha1_VirtualMachineSetResourcePolicySpec_To_v1alpha6_VirtualMachineSetResourcePolicySpec(in, out, s)
}

func Convert_v1alpha6_VirtualMachineSetResourcePolicySpec_To_v1alpha1_VirtualMachineSetResourcePolicySpec(
	...
	return autoConvert_v1alpha6_VirtualMachineSetResourcePolicySpec_To_v1alpha1_VirtualMachineSetResourcePolicySpec(in, out, s)
}
...
func (src *VirtualMachineSetResourcePolicy) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha1_VirtualMachineSetResourcePolicy_To_v1alpha6_VirtualMachineSetResourcePolicy(src, dst, nil)
}
...
func (dst *VirtualMachineSetResourcePolicy) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha6_VirtualMachineSetResourcePolicy_To_v1alpha1_VirtualMachineSetResourcePolicy(src, dst, nil)
}
...
func (src *VirtualMachineSetResourcePolicyList) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha1_VirtualMachineSetResourcePolicyList_To_v1alpha6_VirtualMachineSetResourcePolicyList(src, dst, nil)
}
...
func (dst *VirtualMachineSetResourcePolicyList) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha6_VirtualMachineSetResourcePolicyList_To_v1alpha1_VirtualMachineSetResourcePolicyList(src, dst, nil)
}
